...
{
	int respuesta = -3; //valor de retorno si se ingresó al menos un dato invalido o los parametros son inválidos
	char auxiliarNombre[NOMBRE_LEN];
	int auxiliarHorasTrabajadas;
	int auxiliarSueldo;
 ...
 * \return Retorna 0 si se logró imprimir empleado, -1 si error.
 *
 */
 ...
 * \return Retorna -1 si el puntero al elemento es NULL, 0 si se inicializó ok.
 *
 */
...
/**
 * \brief Calcula el sueldo de un empleado según sus horas trabajadas.
 *
 * \param pElement Puntero al elemento de lista.
 * \return Retorna -1 si el puntero al elemento es NULL, 0 si se calculó ok.
 *
 */
...
/**
 * \brief Analiza si un empleado trabaja o no más de 100 horas.
 *
 * \param pElement Puntero al elemento de lista.
 ...
 *
 * \param pElement Puntero al elemento de lista.
 * \return Retorna 0 si el puntero al elemento es NULL, retorna un valor entero positivo si se realizo la operación.
 *
 */
 ...
 * \return Retorna -1 si los parametros recibidos no son válidos, retorna un valor entero mayor o igual a 0 si ok.
 *
 */
