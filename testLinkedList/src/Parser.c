...
int parser_EmployeeFromText(FILE* pFile, LinkedList* pArrayListEmployee)
{
	...
	do
	{
		/*INTERPRETO COMO TEXTO LA INFORMACIÓN CONTENIDA EN EL ARCHIVO, RESPETANDO LA REGLA DE FORMATO DE LOS DATOS DE CADA BLOQUE.
		 *GUARDO LA INFORMACIÓN, SEGÚN LO ESPECIFICADO EN LA REGLA, EN LOS PUNTEROS A LAS VARIABLES PARASADOS COMO PARAMETROS.*/
